  ...
  return (
    <div className="login-page-container">
      <div className="login-banner-container">
        <img src={login_banner} alt="" className="login-banner" />
      </div>
      <div className="login-container">
        ...
        <form onSubmit={loginUser} className="login-form-container">
            <div className="email-container container">
                <input name="username" type="text" placeholder="Username" className="email"
                />
            </div>
            <div className="phoneaddress-container container">
                <input name="password" type="text" placeholder="Password" className="numberadress" 
                />
            </div>
